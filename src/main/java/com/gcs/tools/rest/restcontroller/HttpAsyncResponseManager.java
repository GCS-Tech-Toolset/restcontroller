...
public class HttpAsyncResponseManager<T>
{
	...
	public final void registerAsyncResponse(@NonNull T refId_, @NonNull AsyncResponse rsps_)
	{
	...
	public final AsyncResponse removeAsyncResposne(@NonNull T refId_)
	{
	...
	public final int getPendingAsyncSize()
	{
	...
	{
		final StringBuilder buff = new StringBuilder("HttpAsyncResponseManager");
	...
	private final class HttpTimeoutHandler implements TimeoutHandler
	{
		...
		public void handleTimeout(AsyncResponse asyncResponse_)
		{
			...
			{
				_logger.debug("[{}] received timeout", ref);
			}
